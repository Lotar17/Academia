...
namespace AcademiaDesktop
{
    public partial class FormLogin : Form
    {
        ...
        private void pictureBoxLinea_Paint(object sender, PaintEventArgs e)
        {
            using (Pen borderPen = new Pen(Color.Gainsboro))
            {
                // Dibujar una línea en la parte inferior del PictureBox
                e.Graphics.DrawLine(borderPen, 0, pictureBoxLinea1.Height - 1, pictureBoxLinea1.Width, pictureBoxLinea1.Height - 1);
            }
        }
    }
}
